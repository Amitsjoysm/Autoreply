...
- **Redirect URI**: https://sync-redis-fix.preview.emergentagent.com/api/oauth/microsoft/callback
...
**Redirect URIs:**
- `https://sync-redis-fix.preview.emergentagent.com/api/oauth/microsoft/callback`

...
2. **Environment Variables Updated**
   ...
   - **Google OAuth**:
     ...
     - Redirect URI: `https://agentfix.preview.emergentagent.com/api/oauth/google/callback`
   - **Groq API**:
...
```
https://agentfix.preview.emergentagent.com/api/oauth/google/callback
```
...
```
https://agentfix.preview.emergentagent.com/api/oauth/microsoft/callback
```

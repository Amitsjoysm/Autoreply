...
2. **Environment Variables Updated**
   ...
   - **Google OAuth**:
     ...
     - Redirect URI: `https://qual-system-review.preview.emergentagent.com/api/oauth/google/callback`
   - **Groq API**:
...
```
https://qual-system-review.preview.emergentagent.com/api/oauth/google/callback
```
...
```
https://qual-system-review.preview.emergentagent.com/api/oauth/microsoft/callback
```

...
2. **Environment Variables Updated**
   ...
   - **Google OAuth**:
     ...
     - Redirect URI: `https://auth-api-integration.preview.emergentagent.com/api/oauth/google/callback`
   - **Groq API**:
...
```
https://auth-api-integration.preview.emergentagent.com/api/oauth/google/callback
```
...
```
https://auth-api-integration.preview.emergentagent.com/api/oauth/microsoft/callback
```

...
**BEFORE:**
```
Line 1: REACT_APP_BACKEND_URL=https://agent-response-fix-3.preview.emergentagent.com
```

**AFTER:**
```
Line 1: REACT_APP_BACKEND_URL=https://c8544c37-151d-4aae-9390-d903791816a0.preview.emergentagent.com
```
...
**BEFORE:**
```
Line 11: GOOGLE_REDIRECT_URI="https://agent-response-fix-3.preview.emergentagent.com/api/oauth/google/callback"
Line 17: MICROSOFT_REDIRECT_URI="https://agent-response-fix-3.preview.emergentagent.com/api/oauth/microsoft/callback"
```

**AFTER:**
```
Line 11: GOOGLE_REDIRECT_URI="https://c8544c37-151d-4aae-9390-d903791816a0.preview.emergentagent.com/api/oauth/google/callback"
Line 17: MICROSOFT_REDIRECT_URI="https://c8544c37-151d-4aae-9390-d903791816a0.preview.emergentagent.com/api/oauth/microsoft/callback"
```

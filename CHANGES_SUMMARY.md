...
**BEFORE:**
```
Line 1: REACT_APP_BACKEND_URL=https://redis-worker-fix-1.preview.emergentagent.com
```
...
**BEFORE:**
```
Line 11: GOOGLE_REDIRECT_URI="https://redis-worker-fix-1.preview.emergentagent.com/api/oauth/google/callback"
Line 17: MICROSOFT_REDIRECT_URI="https://redis-worker-fix-1.preview.emergentagent.com/api/oauth/microsoft/callback"
```

...
**Example:**
```
Current Codespace: https://icon-integration-2.preview.emergentagent.com
Dynamic Redirect URI: https://icon-integration-2.preview.emergentagent.com/api/oauth/google/callback
```

**Important Note for Google Console:**
You need to add the following redirect URIs to your Google OAuth app:
- `https://icon-integration-2.preview.emergentagent.com/api/oauth/google/callback` (wildcard for all Codespaces)
...
1. **For Google OAuth to work in Codespaces**, add this to Google Console:
   ...
   - Add redirect URI: `https://icon-integration-2.preview.emergentagent.com/api/oauth/google/callback`

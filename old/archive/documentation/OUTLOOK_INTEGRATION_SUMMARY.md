...
- **Redirect URI**: https://agent-response-fix-3.preview.emergentagent.com/api/oauth/microsoft/callback
...
**Redirect URIs:**
- `https://agent-response-fix-3.preview.emergentagent.com/api/oauth/microsoft/callback`

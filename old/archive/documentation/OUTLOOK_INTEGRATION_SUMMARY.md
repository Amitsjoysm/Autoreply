...
- **Redirect URI**: https://icon-integration-2.preview.emergentagent.com/api/oauth/microsoft/callback
...
**Redirect URIs:**
- `https://icon-integration-2.preview.emergentagent.com/api/oauth/microsoft/callback`

...
- **Redirect URI**: https://leadreply-debug.preview.emergentagent.com/api/oauth/microsoft/callback
...
**Redirect URIs:**
- `https://leadreply-debug.preview.emergentagent.com/api/oauth/microsoft/callback`

...
### Test Configuration
- **Application URL**: https://auth-api-integration.preview.emergentagent.com
...
- Network request sent to: https://auth-api-integration.preview.emergentagent.com/api/auth/login
...
- Request URL matches expected: https://auth-api-integration.preview.emergentagent.com/api/auth/login
- Request method: POST
- Response status: 200

...
- **Redirect URI**: https://oauth-debug-setup.preview.emergentagent.com/api/oauth/microsoft/callback
...
**Redirect URIs:**
- `https://oauth-debug-setup.preview.emergentagent.com/api/oauth/microsoft/callback`

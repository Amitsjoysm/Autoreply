...
- **Redirect URI**: https://redis-restart-2.preview.emergentagent.com/api/oauth/microsoft/callback
...
**Redirect URIs:**
- `https://redis-restart-2.preview.emergentagent.com/api/oauth/microsoft/callback`

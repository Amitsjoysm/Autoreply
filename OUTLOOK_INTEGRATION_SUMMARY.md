...
- **Redirect URI**: https://ms-auth-connect.preview.emergentagent.com/api/oauth/microsoft/callback
...
**Redirect URIs:**
- `https://ms-auth-connect.preview.emergentagent.com/api/oauth/microsoft/callback`

...
import OutlookEmailAccounts from './pages/OutlookEmailAccounts';
...
import OutlookCalendarProviders from './pages/OutlookCalendarProviders';
...
import {
  ...
  Users, Send, ChevronDown, ChevronRight, List
} from 'lucide-react';
...
const MainLayout = ({ children }) => {
  ...
  const menuItems = [
    ...
    { path: '/calendar-providers', label: 'Google Calendar', icon: Calendar },
    { path: '/outlook-calendar-providers', label: 'Outlook Calendar', icon: Calendar },
    ...
    { path: '/email-accounts', label: 'Gmail Accounts', icon: Mail },
    { path: '/outlook-email-accounts', label: 'Outlook Accounts', icon: Mail },
